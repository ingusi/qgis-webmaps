...
map.getView().fit([-13910589.204170, -8121627.215717, 12941588.374989, 16482017.292872], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Das globale Unterwasserkabel-Netzwerk</h2>';
        return titleElement;
    })(),
...
var searchLayer = new SearchLayer({
    layer: lyr_LandepunkteAnzahlderKabel_5,
    colName: 'name',
    zoom: 10,
    collapsed: true,
    map: map,
